        ...
        <section id="family" className="hy-family hy-section hy-rule-b">
          <div className="hy-wrap" style={{ display: "flex", flexDirection: "column", gap: 28 }}>
            ...
            <div className="hy-family-grid hy-family-grid--5">
              ...
              <div className="hy-product">
                <span className="hy-product-l">ISA audits, inside services OS</span>
                <span className="hy-product-title"><a href="/audit" className="hy-product-h">hysaab audit</a></span>
                <span className="hy-product-p">An ISA audit of IFRS statements, run on a hashed snapshot of the client&rsquo;s books: every journal scored, samples designed and evaluated, schedules tied out, confirmations chased, misstatements aggregated against materiality. A licensed human concludes, and Hysaab never signs an opinion. <strong>Coming soon</strong>.</span>
                <a href="/audit" className="hy-ulink">See hysaab audit →</a>
              </div>
              <div className="hy-product">
