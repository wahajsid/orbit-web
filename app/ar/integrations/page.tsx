...
export const metadata: Metadata = {
  title: "التكاملات — Hysaab",
  description: "كيف يتصل Hysaab بـ Zoho Books وXero وQuickBooks وOdoo وWafeq وERPNext — ويستقبل المستندات من واتساب وتيليغرام والبريد الإلكتروني.",
...
const LEDGERS: { name: string; how: string; detail: string; extras: string[] }[] = [
  {
    ...
    detail: "فوّض مرة واحدة عبر شاشة الموافقة الخاصة بـ Zoho نفسها — لا مفاتيح تنسخها. يكتشف Hysaab مؤسستك، ويطابق شجرة حساباتك، ويرحّل القيود المعتمدة إليه.",
  ...
  },
  {
    ...
    detail: "تدفق موافقة Xero القياسي. يقرأ Hysaab دفتر الأستاذ لأغراض المطابقة، ويمكنه استيراد سجلّك التاريخي لتأتي التقارير بسياقها من اليوم الأول.",
  ...
  },
  {
    ...
    detail: "اتصل عبر التفويض الرسمي من Intuit. يرحّل Hysaab القيود المعتمدة إلى شركتك في QuickBooks ويُبقي مطابقة الحسابات تحت مراجعتك.",
  ...
  },
  {
    ...
    detail: "لوحة إرشادية خطوة بخطوة تريك بالضبط أين تُنشئ مفتاح API داخل نسختك من Odoo. يتحقق Hysaab من الاتصال قبل حفظ أي شيء — فالمفتاح المكتوب خطأً لا يتحول إلى اتصال أبدًا.",
    extras: ["يعمل مع الاستضافة الذاتية وOdoo.sh", "استيراد السجل القديم", "مزامنة المرفقات"],
  },
  {
    name: "Wafeq", how: "‏API KEY · موجَّه",
    detail: "دفتر أستاذ خليجي المنشأ، بدعم من الدرجة الأولى. أنشئ مفتاحًا في Wafeq والصقه مرة واحدة — يتحقق Hysaab منه مباشرة، ثم يرحّل القيود المعتمدة.",
    extras: ["ترحيل القيود", "بالدرهم والريال أصلًا", "ألغِ الوصول في أي وقت من جهة Wafeq"],
  },
  {
    name: "ERPNext", how: "‏API KEY + SECRET · موجَّه",
    detail: "وجّه Hysaab إلى نسختك من ERPNext بزوج مفاتيح API. يُختبر الاتصال قبل حفظه، ويمكن لسجل دفترك العام أن يدخل كبيانات قديمة مُعلَّمة بوضوح.",
      ...
      <main>
        <section className="mg-page-hero">
          ...
          <p className="mg-page-lede">
            ‏Hysaab لا يستبدل نظامك المحاسبي — بل ينجز العمل داخله. اربط دفتر أستاذ
            واحدًا (واحدًا في كل مرة، ليبقى نظام السجل الرسمي واحدًا)، أو لا تربط شيئًا ودَع
            Hysaab يمسك الدفاتر بنفسه.
          </p>
        </section>
        <section className="mg-page-body">
          ...
          <div style={{ marginTop: 56 }}>
            ...
            <p className="mg-page-lede" style={{ marginTop: 0 }}>
              ...
              موثَّقة هي كل ما يحتاجه Hysaab. كل مستند يُقرأ ويُرمَّز ويُختبر ضريبيًا ويُؤرشف
              مع أدلته، سواء رُبط دفتر أستاذ أم لا.
            </p>
            <p className="mg-page-lede" style={{ marginTop: 12 }}>
              نظامك غير موجود هنا؟{" "}
              <a className="textlink" href="mailto:info@hysaab.ai?subject=Integration%20request">اطلب تكاملًا ←</a>
            </p>
          </div>
        </section>
      </main>
