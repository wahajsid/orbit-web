...
const LEDGERS: { name: string; how: string; detail: string; extras: string[] }[] = [
  ...
  // AR-REVIEW: custom connection card
  {
    name: "نظامك", how: "اتصال مخصص · نحدده معك",
    detail: "تستخدم برنامجًا آخر؟ نربط Hysaab ببرنامجك المحاسبي أيًا كان. نحدد نطاق الاتصال معك كتابيًا قبل أي التزام، ويعمل وفق قواعد الاعتماد نفسها المطبقة على كل دفتر أعلاه.",
    extras: ["أي برنامج محاسبي", "نطاق مكتوب أولًا", "قواعد الاعتماد نفسها"],
  },
];
        ...
        <div className="hw-wrap hw-section">
          <div className="hw-heading">
            <div>
              ...
              <h2>ستة دفاتر أستاذ جاهزة.<br /><span>وأي نظام آخر نربطه لك.</span></h2>
            </div>
