        ...
        <tr><td style="padding:34px 36px 8px 36px;font-family:Arial,Helvetica,sans-serif;">
          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:6px 0 20px 0;">
            <tr><td style="background:#F7F5F0;border:1px solid #D8D4CA;border-radius:6px;padding:18px 20px;">
              ...
              <div style="font-family:Arial,Helvetica,sans-serif;font-size:15px;color:#1D1D1B;line-height:1.6;">The <strong>first 100 sign-ups get Orbit free for a year</strong> (fair-usage policy applies), with founder pricing locked in after that. We open the doors on <strong>${LAUNCH_DATE_LONG}</strong>.</div>
            </td></tr>
          </table>
...
You're early — and that counts: the first 100 sign-ups get Orbit free for a year (fair-usage policy applies), founder pricing locked in after. We open the doors on ${LAUNCH_DATE_LONG}.
