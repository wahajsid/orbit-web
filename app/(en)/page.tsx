...
export const metadata = {
  ...
  description:
    "An accounting and reporting team for Gulf businesses, built on evidence, professional judgement and human oversight. Hysaab prepares the books and brings you the decisions that are yours. Built in Dubai.",
      ...
      <main id="main">
          ...
          <div className="hw-wrap hw-hero-grid">
            <div className="hw-hero-copy">
              ...
              <div className="hw-actions">
                <a className="hw-btn hw-btn--peach" href="#conversation">Meet the team <span aria-hidden="true">↗</span></a>
        ...
        <section className="hw-work" id="how-it-works">
          <div className="hw-wrap hw-section">
            <div className="hw-heading">
              <div>
                <p className="hw-eyebrow">01 / How it works</p>
        ...
        <section id="experience" className="hw-experience">
          <div className="hw-wrap hw-section">
            <div className="hw-heading">
              <div>
                <p className="hw-eyebrow">02 / Five moments in your working day</p>
              ...
              <div className="hw-shots-grid">
                {moments.map((m) => (
                  <article key={m.key}>
                    ...
                    <p>{m.ready ? m.caption : m.pending}</p>
                  </article>
                ))}
                <aside className="hw-shots-note">
                  <span className="hw-mono">About these screens</span>
                  <p>{pendingCount > 0 ? `${pendingCount} of ${moments.length} captures are still pending and labelled as such. The rest are captures` : "Captures"} of the Hysaab workspace running its sample dataset. Each thumbnail shows the top of the screen; select one to see it in full.</p>
        ...
        <section className="hw-control" id="control">
          <div className="hw-wrap hw-section hw-control-grid">
            <div>
              <p className="hw-eyebrow">03 / Your control</p>
        ...
        <section id="ways" className="hw-ways">
          <div className="hw-wrap hw-section">
            <div className="hw-heading">
              <div>
                <p className="hw-eyebrow">04 / Ways to work</p>
            ...
            <div className="hw-ways-grid">
              <article>
                ...
                <InterestLink interest="Own team">Explore the workspace <span aria-hidden="true">↗</span></InterestLink>
              </article>
              <article>
        ...
        <section id="products" className="hw-products">
          ...
          <div className="hw-wrap hw-section">
            <div className="hw-heading">
              <div>
                <p className="hw-eyebrow">05 / The Hysaab family</p>
