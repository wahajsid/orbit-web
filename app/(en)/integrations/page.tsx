...
export const metadata: Metadata = {
  title: "Integrations — Hysaab",
  description: "How Hysaab connects to Zoho Books, Xero, QuickBooks, Odoo, Wafeq and ERPNext — and takes documents from WhatsApp, Telegram and email.",
...
const LEDGERS: { name: string; how: string; detail: string; extras: string[] }[] = [
  {
    ...
    detail: "Authorize once on Zoho's own consent screen — no keys to copy. Hysaab discovers your organisation, maps your chart of accounts, and posts approved journals back.",
  ...
  },
  {
    ...
    detail: "Standard Xero consent flow. Hysaab reads the ledger for reconciliation and can import your history so reports have context from day one.",
  ...
  },
  {
    ...
    detail: "Connect through Intuit's official authorization. Hysaab posts approved journals into your QuickBooks company and keeps the account mapping under your review.",
  ...
  },
  {
    ...
    detail: "A step-by-step panel shows exactly where to create the API key inside your own Odoo instance. Hysaab authenticates before storing anything — a typo'd key never becomes a connection.",
    extras: ["Works with self-hosted and Odoo.sh", "Legacy-history import", "Attachment sync"],
  },
  {
    name: "Wafeq", how: "API KEY · GUIDED",
    detail: "Gulf-native ledger, first-class support. Generate a key in Wafeq, paste it once — Hysaab verifies it live, then posts approved journals.",
    extras: ["Journal posting", "AED/SAR native", "Revoke any time from Wafeq's side"],
  },
  {
    name: "ERPNext", how: "API KEY + SECRET · GUIDED",
    detail: "Point Hysaab at your ERPNext instance with an API key pair. Connection is tested before it's saved, and your GL history can ride in as clearly-marked legacy data.",
      ...
      <main>
        <section className="mg-page-hero">
          ...
          <p className="mg-page-lede">
            Hysaab doesn&rsquo;t replace your accounting system — it does the work inside it. Connect one
            ledger (one at a time, so there&rsquo;s a single source of truth), or connect nothing and let
            Hysaab keep the books itself.
          </p>
        </section>
        <section className="mg-page-body">
          ...
          <div style={{ marginTop: 56 }}>
            ...
            <p className="mg-page-lede" style={{ marginTop: 0 }}>
              ...
              Hysaab needs. Every document is read, coded, tax-tested and filed with its evidence,
              whether or not a ledger is connected.
            </p>
            <p className="mg-page-lede" style={{ marginTop: 12 }}>
              Missing your system?{" "}
              <a className="textlink" href="mailto:info@hysaab.ai?subject=Integration%20request">Request an integration →</a>
            </p>
          </div>
        </section>
      </main>
